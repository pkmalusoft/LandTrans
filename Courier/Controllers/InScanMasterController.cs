...
namespace LTMSV2.Controllers
{
    public class InScanMasterController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<InScanMasterVM> lst = (from c in db.InScanMasters select new InScanMasterVM { AWBNo = c.ConsignmentNo, Consignor = c.Consignor, Consignee = c.Consignee, ConsigneeLocationName = c.ConsigneeLocationName, InScanID = c.InScanID, TransactionDate = c.TransactionDate }).ToList();
