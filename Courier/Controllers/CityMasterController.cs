...
namespace LTMSV2.Controllers
{
    public class CityMasterController : Controller
    {
        ...
        {
            List<CityVM> lst = (from c in db.CityMasters join t in db.CountryMasters on c.CountryID equals t.CountryID select new CityVM { CityID = c.CityID, CityCode = c.AreaCode, City = c.City, Country = t.CountryName }).ToList();
